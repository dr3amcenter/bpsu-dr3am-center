<script lang="ts">
	...
	import { deleteCategorySchema, type DeleteCategorySchema } from "../(data)/schema";
	...
	export let theForm: SuperValidated<Infer<DeleteCategorySchema>> = $page.data.deleteCategoryForm;
