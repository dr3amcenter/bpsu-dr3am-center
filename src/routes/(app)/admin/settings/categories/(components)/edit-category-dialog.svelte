<script lang="ts">
	...
	import { editCategorySchema, type EditCategorySchema } from "../(data)/schema";
	...
	export let theForm: SuperValidated<Infer<EditCategorySchema>> = $page.data.editCategoryForm;
