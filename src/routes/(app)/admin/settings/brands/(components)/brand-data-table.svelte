<script lang="ts">
	...
	import BrandDataTableActions from "./brand-data-table-actions.svelte";
	...
	const columns = table.createColumns([
		...
		table.column({
			...
			header: "",
			cell: ({ value }) => {
				return createRender(BrandDataTableActions, { brandName: value.brandName });
			},
			plugins: {
				filter: {
					exclude: true
