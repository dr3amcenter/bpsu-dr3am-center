<script lang="ts">
	...
	import { editLocationSchema } from "$lib/zod-schemas/location.schema";
	...
	export let theForm: SuperValidated<Infer<typeof editLocationSchema>> =
		$page.data.editLocationForm;
