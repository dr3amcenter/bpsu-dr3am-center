<script lang="ts">
	...
	import { deleteLocationSchema, type DeleteLocationSchema } from "../(data)/schema";
	...
	export let theForm: SuperValidated<Infer<DeleteLocationSchema>> = $page.data.deleteLocationForm;
